        ...
        <div className="ivory-div">
          <div className="container py-5">
            <div className="row py-5 py-lg-3">
              <div className="col-lg-6">
                <div className="ml-lg-5 pl-lg-5 pt-5 pb-lg-5 my-0 my-lg-5">
                  <h1 className="font-md-title">Benchtop Multiplex Assay Reader System (MARS<sup>TM</sup>)</h1>
              ...
              <div className="col-lg-6 col-10 mx-0 my-0 my-lg-3 py-0 py-lg-5">
            ...
            <div className="row py-5 py-lg-3">
              <div className="col-lg-6">
                <div className="ml-lg-5 pl-lg-5 pt-5 pb-lg-5 my-0 my-lg-5">
                  <h1 className="font-md-title">Portable Multiplex Assay Reader System (MobileMARS<sup>TM</sup>)</h1>
                  <h3 className="font-sp">Bring multiplex capabilities to any setting</h3>
                  <p>
                    Our handheld instrument can perform manual multiplex measurements in low-resource or point-of-care clinical settings. Comes with MARSoft software for plug-and-play multiplex measurements (PC compatible).
                  </p>
                  <a href="/contactUs" className="btn btn-outline-dark round" role="button" aria-disabled="true">Get Quote</a>
                </div>
              </div>
